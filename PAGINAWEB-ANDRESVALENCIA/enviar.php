...
$dbname = "valencia"; // Cambia esto por el nombre de tu base de datos
...
$sql = "INSERT INTO cursos (NOMBRE, APELLIDOS, CORREO_ELECTRONICO) VALUES ('$NOMBRE', '$APELLIDOS', '$CORREO_ELECTRONICO')";
